...
public abstract class Parser<T> {
   ...
   * have to use a pattern like: {@code "<div\s+[^>]*dir='rtl'>"}. Such regex is awkward to express
   * and inherently requires backtracking because {@code [^>]+} can eat up the "dir..." characters
   * so the regex engine would have to back track in order to match those later patterns.
   *
