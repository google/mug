...
- The first and only Java combinator designed to **supersede Regex**.
...
- **Freakin fast**! (even faster than mainstream parser generators like ANTLR and JavaCC - [benchmark](./parser-benchmarks.md)).
