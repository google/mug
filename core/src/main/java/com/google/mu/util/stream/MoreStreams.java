...
public final class MoreStreams {
   ...
   * }</pre>
   *
   * See {@link com.google.mu.util.algo.ShortestPaths} for an example how {@code whileNotEmpty()}
   * can be used to build reusable, lazily-evaluated Dijkstra shortest-path algorithm.
   *
