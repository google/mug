...
public final class CelParserTest {
  ...
  public void testComplexBinaryAndPrecedence() throws Exception {
    ...
    assertThat(parser.parse("!a && b || c"))
        .isEqualTo(
            not(new Ident("a", 1)).withSourceIndex(0)
                .and(new Ident("b", 6))
                .withSourceIndex(3)
                .or(new Ident("c", 11))
                .withSourceIndex(8));
  ...
  public void testInvalidSyntax() throws Exception {
    ...
    assertParseFailure("\"hello\\ nworld\"", "1:8", EXPECTED_STRING_ESCAPE_CHAR + ", encountered:");
  ...
  public void testCppSuite_invalid() {
    ...
    assertParseFailure("a.`@foo`", "1:4", "expecting <one or more [a-zA-Z0-9_./ -]>, encountered:");
    assertParseFailure("a.`$foo`", "1:4", "expecting <one or more [a-zA-Z0-9_./ -]>, encountered:");
    assertParseFailure("`a.b`", "1:1", EXPECTED_EXPR_START + ", encountered:");
    assertParseFailure("`a.b`()", "1:1", EXPECTED_EXPR_START + ", encountered:");
