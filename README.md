...
A small Java 8+ string processing and streams library ([javadoc](http://google.github.io/mug/apidocs/index.html)), battle tested in Google's internal codebase, with **0 deps** (Proto, BigQuery, Guava addons are in separate artifacts). ![](https://travis-ci.org/google/mug.svg?branch=master)
...
- [`DateTimeFormats`](./mug/src/main/java/com/google/mu/time/README.md) – define datetime formats by _examples_  
  → `DateTimeFormatter format = formatOf("2024-03-14 10.90:00.123 America/New_York")`
...
Add to build.gradle:
```
  implementation 'com.google.mug:mug:10.9'
  implementation 'com.google.mug:mug-safesql:10.9'
  implementation 'com.google.mug:dot-parse:10.9'
  implementation 'com.google.mug:mug-guava:10.9'
  implementation 'com.google.mug:mug-protobuf:10.9'
```
</details>
