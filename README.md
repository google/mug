...
- ✅ [`SafeSql`](./mug-safesql/src/main/java/com/google/mu/safesql/README.md) – _library-enforced_ safe SQL template  
...
Add to build.gradle:
```
  implementation 'com.google.mug:mug:9.0'
  implementation 'com.google.mug:mug-guava:9.0'
  implementation 'com.google.mug:mug-protobuf:9.0'
```
</details>
