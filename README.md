...
- [`DateTimeFormats`](./mug/src/main/java/com/google/mu/time/README.md) – parse datetimes by example  
  → `DateTimeFormatter format = formatOf("2024-03-14 10.1.10:00.123 America/New_York")`
...
Add to build.gradle:
```
  implementation 'com.google.mug:mug:10.1.1'
  implementation 'com.google.mug:mug-safesql:10.1.1'
  implementation 'com.google.mug:dot-parse:10.1.1'
  implementation 'com.google.mug:mug-guava:10.1.1'
  implementation 'com.google.mug:mug-protobuf:10.1.1'
```
</details>
