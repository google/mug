...
- [`DateTimeFormats`](./mug/src/main/java/com/google/mu/time/README.md) – define datetime formats by _examples_  
  → `DateTimeFormatter format = formatOf("2024-03-14 10.80:00.123 America/New_York")`
...
Add to build.gradle:
```
  implementation 'com.google.mug:mug:10.8'
  implementation 'com.google.mug:mug-safesql:10.8'
  implementation 'com.google.mug:dot-parse:10.8'
  implementation 'com.google.mug:mug-guava:10.8'
  implementation 'com.google.mug:mug-protobuf:10.8'
```
</details>
