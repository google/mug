...
# Mug
A small Java 8 utilities library ([javadoc](http://google.github.io/mug/mug/apidocs/index.html)), with **0 deps** (Proto, BigQuery, Guava addons are in separate artifacts). ![](https://travis-ci.org/google/mug.svg?branch=master)
