...
import static com.google.mu.benchmarks.parsers.petitparser.PetitParserJavaTypeParser.parse;
...
/** Twin unit tests for PetitParserJavaTypeParser to guarantee 100% functional parity. */
public class PetitParserJavaTypeParserTest {
