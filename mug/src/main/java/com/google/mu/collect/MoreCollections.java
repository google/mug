...
public final class MoreCollections {
  /**
   * If {@code collection} has at least two elements, passes the first two elements to {@code found}
  ...
  /**
   * If {@code collection} has at least 3 elements, passes the first 3 elements to {@code found}
   * function and returns the non-null result wrapped in an {@link Optional}, or else returns {@code
   * Optional.empty()}.
   *
   * @throws NullPointerException if {@code collection} or {@code found} function is null, or if
  ...
  /**
   * If {@code collection} has at least 4 elements, passes the first 4 elements to {@code found}
   * function and returns the non-null result wrapped in an {@link Optional}, or else returns {@code
   * Optional.empty()}.
   *
   * @throws NullPointerException if {@code collection} or {@code found} function is null, or if
  ...
  /**
   * If {@code collection} has at least 5 elements, passes the first 5 elements to {@code found}
   * function and returns the non-null result wrapped in an {@link Optional}, or else returns {@code
   * Optional.empty()}.
   *
   * @throws NullPointerException if {@code collection} or {@code found} function is null, or if
  ...
  public static <T, R> Optional<R> findFirstElements(
    ...
    if (collection instanceof List && collection instanceof RandomAccess) {
      List<T> list = (List<T>) collection;
      return Optional.of(
          found.map(list.get(0), list.get(1), list.get(2), list.get(3), list.get(4)));
    }
    Iterator<T> it = collection.iterator();
  ...
  /**
   * If {@code collection} has at least 6 elements, passes the first 6 elements to {@code found}
   * function and returns the non-null result wrapped in an {@link Optional}, or else returns {@code
   * Optional.empty()}.
   *
   * @throws NullPointerException if {@code collection} or {@code found} function is null, or if
  ...
  public static <T, R> Optional<R> findFirstElements(
    ...
    if (collection instanceof List && collection instanceof RandomAccess) {
      List<T> list = (List<T>) collection;
      return Optional.of(
          found.map(list.get(0), list.get(1), list.get(2), list.get(3), list.get(4), list.get(5)));
    }
    Iterator<T> it = collection.iterator();
   ...
   * when all elements match the predicate, making it an <em>accidental</em> "view"; but if you
   * later change {@code list}'s content, it may break expectations from your code that all elements
   * in the {@code filter()}'ed list shall match the {@code predicate}.
   *
   * @since 10.7
   */
