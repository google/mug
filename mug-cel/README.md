...
`mug-cel` is optimized for parsing speed. [JMH benchmarks](benchmarks.md) show it parses expressions **1.5x to 2.7x faster** than the standard ANTLR-based `cel-java` parser across various workloads.
